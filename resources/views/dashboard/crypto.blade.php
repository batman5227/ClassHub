...
@section('content')
        ...
        <div class="row">
            <div class="col-xxl-3">
                <div class="card card-height-100">
                    ...
                    <div class="card-body">
                        <div id="portfolio_donut_charts" data-colors="[" --vz-primary",="" "--vz-info",="" "--vz-warning",="" "--vz-success"]"="" data-colors-minimal="[" "--vz-primary-rgb,="" 0.85",="" 0.65",="" 0.50"]"="" data-colors-interactive="[" data-colors-corporate="[" "--vz-secondary",="" data-colors-galaxy="[" class="apex-charts" dir="ltr"></div>
                        ...
                        <ul class="list-group list-group-flush border-dashed mb-0 mt-3 pt-2">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 avatar-xs">
                                        <span class="avatar-title bg-light p-1 rounded-circle material-shadow">
                                            <img src="{{ asset('assets/images/btc.svg') }}" class="img-fluid" alt="">
                                        </span>
                                    </div>
                            ...
                            <li class="list-group-item px-0">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 avatar-xs">
                                        <span class="avatar-title bg-light p-1 rounded-circle material-shadow">
                                            <img src="{{ asset('assets/images/eth.svg') }}" class="img-fluid" alt="">
                                        </span>
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                            ...
                            <li class="list-group-item px-0">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 avatar-xs">
                                        <span class="avatar-title bg-light p-1 rounded-circle material-shadow">
                                            <img src="{{ asset('assets/images/ltc.svg') }}" class="img-fluid" alt="">
                                        </span>
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                            ...
                            <li class="list-group-item px-0 pb-0">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 avatar-xs">
                                        <span class="avatar-title bg-light p-1 rounded-circle material-shadow">
                                            <img src="{{ asset('assets/images/dash.svg') }}" class="img-fluid" alt="">
                                        </span>
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img src="{{ asset('assets/images/btc.svg') }}" alt="" class="avatar-xxs material-shadow">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img src="{{ asset('assets/images/ltc.svg') }}" alt="" class="avatar-xxs material-shadow">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img src="{{ asset('assets/images/eth.svg') }}" alt="" class="avatar-xxs material-shadow">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img src="{{ asset('assets/images/bnb.svg') }}" alt="" class="avatar-xxs material-shadow">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img src="{{ asset('assets/images/usdt.svg') }}" alt="" class="avatar-xxs material-shadow">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img src="{{ asset('assets/images/dash.svg') }}" alt="" class="avatar-xxs material-shadow">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img src="{{ asset('assets/images/neo.svg') }}" alt="" class="avatar-xxs material-shadow">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2">
                                                    <img src="{{ asset('assets/images/doge.svg') }}" alt="" class="avatar-xxs material-shadow">
                                                </div>
                                                <div>
                    ...
                    <div class="card-body p-0">
                        <ul class="list-group list-group-flush border-dashed mb-0">
                            <li class="list-group-item d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/btc.svg') }}" class="avatar-xs" alt="">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <li class="list-group-item d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/eth.svg') }}" class="avatar-xs material-shadow" alt="">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <li class="list-group-item d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/aave.svg') }}" class="avatar-xs material-shadow" alt="">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <li class="list-group-item d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/doge.svg') }}" class="avatar-xs material-shadow" alt="">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <li class="list-group-item d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/bnb.svg') }}" class="avatar-xs material-shadow" alt="">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <li class="list-group-item d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assets/images/ltc.svg') }}" class="avatar-xs material-shadow" alt="">
                                </div>
                                <div class="flex-grow-1 ms-3">
                ...
                <div class="card card-height-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-middle">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets/images/img-1.jpg') }}" class="rounded img-fluid material-shadow" style="height: 60px;" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex mt-4">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets/images/img-2.jpg') }}" class="rounded img-fluid material-shadow" style="height: 60px;" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex mt-4">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets/images/img-3.jpg') }}" class="rounded img-fluid material-shadow" style="height: 60px;" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-flex mt-4">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets/images/img-6.jpg') }}" class="rounded img-fluid material-shadow" style="height: 60px;" alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
    ...
    @section('script')
        <!-- CRM js -->
        <script src="{{ asset('assets/js/dashboard-crypto.init.js') }}"></script>

        <script>
            document.addEventListener("DOMContentLoaded", function () {

                // Read colors from HTML
                function getChartColorsArray(id) {
                    ...
                    try {
                        ...
                        console.error("Invalid JSON in data-colors for #" + id);
                        return [];
                    }
                }

                function renderPortfolioDonutChart(data, labels) {
                    var chartColors = getChartColorsArray("portfolio_donut_charts");
                    ...
                    var options = {
                        ...
                        series: data,      // Dynamic values
                        labels: labels,    // Dynamic names
                        colors: chartColors,
                    ...
                    var chartEl = document.querySelector("#portfolio_donut_charts");
                    if (!chartEl) {
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                // Utility: Read JSON colors from data-colors attribute
                function getChartColorsArray(id) {
                    var el = document.getElementById(id);
                    if (!el) return [];
                ...
                function renderMarketChart() {
                    var chartColors = getChartColorsArray("Market_chart");
                    ...
                    var options = {
                        ...
                        colors: chartColors, // e.g: ["--vz-success", "--vz-danger"]

                        series: [
                            {
                                name: "Crypto Value",
                                data: [
                                    0.0124, 0.0131, 0.0143, 0.0137, 0.0148, 0.0162,
                                    0.0175, 0.0181, 0.0174, 0.0192, 0.0201, 0.0193
                                ]
                            }
                        ],
                    ...
                    new ApexCharts(document.querySelector("#Market_chart"), options).render();
                }
