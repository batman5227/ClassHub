                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body pb-0">
                                    <div id="sales-forecast-chart" data-colors="[" --vz-primary",="" "--vz-success",="" "--vz-warning"]"="" data-colors-minimal="[" --vz-primary-rgb,="" 0.75",="" "--vz-primary",="" "--vz-primary-rgb,="" 0.55"]"="" data-colors-creative="[" "--vz-secondary",="" "--vz-info"]"="" data-colors-corporate="[" "--vz-secondary"]"="" data-colors-galaxy="[" data-colors-classic="[" "--vz-warning",="" class="apex-charts" dir="ltr"></div>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end col -->
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body pb-0">
                                    <div id="deal-type-charts" data-colors="[" --vz-warning",="" "--vz-danger",="" "--vz-success"]"="" data-colors-minimal="[" --vz-primary-rgb,="" 0.15",="" "--vz-primary-rgb,="" 0.35",="" 0.45"]"="" data-colors-modern="[" "--vz-secondary",="" data-colors-interactive="[" "--vz-info",="" "--vz-primary"]"="" data-colors-corporate="[" --vz-secondary",="" data-colors-classic="[" class="apex-charts" dir="ltr"></div>
                                </div><!-- end card body -->
                            </div><!-- end card -->
                        </div><!-- end col -->
                        ...
                        <div class="col-xxl-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body px-0">
                                    ...
                                    <div id="revenue-expenses-charts" data-colors="[" --vz-success",="" "--vz-danger"]"="" data-colors-minimal="[" --vz-primary",="" "--vz-info"]"="" data-colors-interactive="[" --vz-info",="" "--vz-primary"]"="" data-colors-galaxy="[" "--vz-secondary"]"="" data-colors-classic="[" class="apex-charts" dir="ltr"></div>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end col -->
                    </div><!-- end row -->
                                        ...
                                        <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Absternet LLC</td>
                                                    <td>Sep 20, 2021</td>
                                                    <td><img src="{{ asset('assets/images/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
                                                        <a href="#javascript: void(0);" class="text-body fw-medium">StarCode Kh</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>Raitech Soft</td>
                                                    <td>Sep 23, 2021</td>
                                                    <td><img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
                                                ...
                                                <tr>
                                                    <td>William PVT</td>
                                                    <td>Sep 27, 2021</td>
                                                    <td><img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
                                                ...
                                                <tr>
                                                    <td>Loiusee LLP</td>
                                                    <td>Sep 30, 2021</td>
                                                    <td><img src="{{ asset('assets/images/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
                                                ...
                                                <tr>
                                                    <td>Apple Inc.</td>
                                                    <td>Sep 30, 2021</td>
                                                    <td><img src="{{ asset('assets/images/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
                                                        <a href="#javascript: void(0);" class="text-body fw-medium">Vitoria Rodrigues</a>
                                                    </td>
                                        ...
                                        <ul class="list-group list-group-flush border-dashed px-3">
                                            ...
                                            <li class="list-group-item ps-0">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <label class="form-check-label mb-0 ps-2" for="task_six">Styling wireframe design and documentation for Template admin</label>
                                                    </div>
                                                    <div class="flex-shrink-0 ms-2">
                                                        <p class="text-muted fs-12 mb-0">27 Sep, 2021</p>
                                                    </div>
                                                    ...
                                                    <div class="avatar-group">
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
                                                                <img src="{{ asset('assets/images/avatar-1.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Jansh Brown">
                                                                <img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Dan Gibson">
                                                                <img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item material-shadow">
                                                    ...
                                                    <div class="avatar-group">
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Frida Bang">
                                                                <img src="{{ asset('assets/images/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Malou Silva">
                                                                <img src="{{ asset('assets/images/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Simon Schmidt">
                                                                <img src="{{ asset('assets/images/avatar-6.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Tosh Jessen">
                                                                <img src="{{ asset('assets/images/avatar-7.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);">
                                                    ...
                                                    <div class="avatar-group">
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Nina Schmidt">
                                                                <img src="{{ asset('assets/images/avatar-8.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                            </a>
                                                        </div>
                                                        <div class="avatar-group-item material-shadow">
                                                            <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>William PVT</td>
                                                    <td><img src="{{ asset('assets/images/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 material-shadow">
    ...
    @section('script')
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                /* -------------------------------------------------------------
                *  SALES FORECAST CHART (COLUMN + LINE)
                * ------------------------------------------------------------- */
                function renderSalesForecastChart(salesData, forecastData) {
                    var options = {
                        ...
                        // 🎨 Bar + Line colors (in order)
                        colors: ["#299cdb", "#f7b84b", "#f06548", "#0ab39c"],

                        stroke: { width: [0, 3], curve: "smooth" },

                        plotOptions: {
                            bar: {
                                distributed: true,   // 🔥 IMPORTANT → Individual bar colors
                                columnWidth: "45%",
                                borderRadius: 6
                            }
                        },
                    ...
                    new ApexCharts(document.querySelector("#sales-forecast-chart"), options).render();
                }

                /* -------------------------------------------------------------
                *  DEAL TYPE DONUT CHART
                * ------------------------------------------------------------- */
                function renderDealTypeChart(labels, values) {
                    var options = {
                    ...
                    new ApexCharts(document.querySelector("#deal-type-charts"), options).render();
                }

                /* -------------------------------------------------------------
                *  REVENUE vs EXPENSES AREA CHART
                * ------------------------------------------------------------- */
                function renderRevenueExpensesChart(revenue, expenses) {
                    var options = {
                        chart: { height: 330, type: "area", toolbar: { show: false } },
                ...
                /* -------------------------------------------------------------
                *  RENDER WITH EXAMPLE DATA (YOU CAN REPLACE WITH LARAVEL / API)
                * ------------------------------------------------------------- */
                ...
                renderDealTypeChart(
                    ["Closed Deals", "Pending Deals", "Rejected Deals"],
                    [55, 30, 15]
                );

                renderRevenueExpensesChart(
                    [50, 65, 70, 85, 95, 120, 140, 160, 180, 200, 220, 250], // revenue
                    [40, 55, 60, 70, 80, 95, 100, 110, 130, 135, 150, 170]   // expenses
                );
            });
        </script>
    @endsection
