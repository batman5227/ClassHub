...
@section('content')
                                            ...
                                            <div class="row g-0">
                                                <div class="col-xxl-8">
                                                    <div class="">
                                                        ...
                                                        <div id="line_chart_basic" data-colors="[" --vz-primary","--vz-success",="" "--vz-light"]"="" data-colors-corporate="[" --vz-primary","--vz-secondary",="" data-colors-galaxy="[" "--vz-secondary"]"="" data-colors-classic="[" --vz-primary","--vz-light",="" class="apex-charts" dir="ltr"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="border-start p-4 h-100 d-flex flex-column">
                                                        ...
                                                        <div class="w-100">
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ asset('assets/images/img-2.gif') }}" class="img-fluid avatar-xs rounded-circle object-fit-cover" alt="">
                                        ...
                                        <div data-simplebar="" style="max-height: 365px;">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar-10.jpg') }}" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/img-01.jpg') }}" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/img-04.jpg') }}" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/img-06.jpg') }}" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/avatar-8.jpg') }}" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/img-03.jpg') }}" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/img-05.jpg') }}" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                                <h6 class="fs-14 mb-1">Timothy Smith</h6>
                                                            </a>
                            ...
                            <div class="swiper marketplace-swiper rounded gallery-light">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            <div class="explore-place-bid-img">
                                                <img src="{{ asset('assets/images/img-3.gif') }}" alt="" class="img-fluid card-img-top explore-img">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            <div class="explore-place-bid-img">
                                                <img src="{{ asset('assets/images/img-03.jpg') }}" alt="" class="img-fluid card-img-top explore-img">
                                                <div class="bg-overlay"></div>
                                                <div class="place-bid-btn">
                                                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            <div class="explore-place-bid-img">
                                                <img src="{{ asset('assets/images/img-1.gif') }}" alt="" class="img-fluid card-img-top explore-img">
                                                <div class="bg-overlay"></div>
                                                <div class="place-bid-btn">
                                                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            <div class="explore-place-bid-img">
                                                <img src="{{ asset('assets/images/img-4.gif') }}" alt="" class="img-fluid card-img-top explore-img">
                                                <div class="bg-overlay"></div>
                                                <div class="place-bid-btn">
                                                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                                </div>
                                            ...
                                            <table class="table table-borderless align-middle">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ asset('assets/images/img-01.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ asset('assets/images/img-02.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ asset('assets/images/img-03.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ asset('assets/images/img-04.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ asset('assets/images/img-05.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ asset('assets/images/img-06.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="{{ asset('assets/images/img-5.gif') }}" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="{{ asset('assets/images/img-01.jpg') }}" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                    ...
                                                    <td><img src="{{ asset('assets/images/btc.svg') }}" class="avatar-xxs me-2" alt="">48,568.025</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="{{ asset('assets/images/img-5.gif') }}" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                    ...
                                                    <td><img src="{{ asset('assets/images/ltc.svg') }}" class="avatar-xxs me-2" alt="">87,142.027</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="{{ asset('assets/images/img-06.jpg') }}" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                    ...
                                                    <td><img src="{{ asset('assets/images/etc.svg') }}" class="avatar-xxs me-2" alt="">33,847.961</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="{{ asset('assets/images/img-04.jpg') }}" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                    ...
                                                    <td><img src="{{ asset('assets/images/dash.svg') }}" class="avatar-xxs me-2" alt="">73,654.421</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="{{ asset('assets/images/img-03.jpg') }}" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                    ...
                                                    <td><img src="{{ asset('assets/images/bnb.svg') }}" class="avatar-xxs me-2" alt="">66,742.077</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="{{ asset('assets/images/img-02.jpg') }}" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                    ...
                                                    <td><img src="{{ asset('assets/images/usdt.svg') }}" class="avatar-xxs me-2" alt="">34,736.209</td>
                                                    <td>
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-1">
                                        <p class="mb-1"><img src="{{ asset('assets/images/us.svg') }}" alt="" height="15" class="rounded me-2"> United States <span class="float-end">34%</span></p>
                                        <p class="mb-1"><img src="{{ asset('assets/images/russia.svg') }}" alt="" height="15" class="rounded me-2"> Russia <span class="float-end">27%</span></p>
                                        <p class="mb-1"><img src="{{ asset('assets/images/spain.svg') }}" alt="" height="15" class="rounded me-2"> Spain <span class="float-end">21%</span></p>
                                        <p class="mb-1"><img src="{{ asset('assets/images/italy.svg') }}" alt="" height="15" class="rounded me-2"> Italy <span class="float-end">13%</span></p>
                                    </div>
                                </div>
                                <!-- end card body -->
                            </div>
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <a href="apps-nft-collections.html" type="button" class="btn btn-soft-primary btn-sm flex-shrink-0 material-shadow-none">
                                        See All <i class="ri-arrow-right-line align-bottom"></i>
                                    </a>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="{{ asset('assets/images/img-03.jpg') }}" alt="" height="220" class="object-fit-cover w-100">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="{{ asset('assets/images/img-04.jpg') }}" alt="" height="220" class="object-fit-cover w-100">
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="{{ asset('assets/images/img-5.gif') }}" alt="" height="220" class="object-fit-cover w-100">
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="{{ asset('assets/images/img-06.jpg') }}" alt="" height="220" class="object-fit-cover w-100">
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <a href="apps-nft-creators.html" type="button" class="btn btn-soft-primary btn-sm flex-shrink-0 material-shadow-none">
                                        See All <i class="ri-arrow-right-line align-bottom"></i>
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="swiper collection-slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="{{ asset('assets/images/img-02.jpg') }}" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="{{ asset('assets/images/img-01.jpg') }}" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                                        <a href="pages-profile.html">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="{{ asset('assets/images/img-04.jpg') }}" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                                        <a href="pages-profile.html">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="{{ asset('assets/images/avatar-1.jpg') }}" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                                        <a href="pages-profile.html">
    ...
    @section('script')
        <!-- Marketplace init -->
        <script src="{{ asset('assets/js/dashboard-nft.init.js') }}"></script>

        <script>
            document.addEventListener("DOMContentLoaded", function () {

                function getChartColorsArray(e) {
                    var colors = document.querySelector(e).getAttribute("data-colors");
                    colors = JSON.parse(colors.replace(/ /g, ''));
                    return colors;
                }
                // Chart Colors
                var chartColors = getChartColorsArray("#market-overview");

                var options = {
                    series: [{
                        name: "Users",
                        data: [20, 45, 32, 50, 78, 90, 110]
                    }],
                    chart: {
                        type: "area",
                        height: 220,
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                // Function to parse the data-colors attribute
                function getChartColorsArray(selector) {
                    var colors = document.querySelector(selector).getAttribute("data-colors");
                    ...
                    if (colors) {
                        ...
                        try {
                            ...
                            return ["#405189", "#0ab39c", "#f7b84b"]; // fallback
                        }
                    }
                ...
                // Get chart colors
                var chartColors = getChartColorsArray("#line_chart_basic");

                var options = {
                    series: [
                        {
                            name: "Artworks",
                            data: [20, 40, 35, 50, 49, 65, 80, 90, 100, 120, 150, 170]
                        },
                        {
                            name: "Auction",
                            data: [10, 20, 18, 35, 30, 40, 55, 65, 75, 90, 110, 130]
                        },
                        {
                            name: "Creators",
                            data: [5, 10, 8, 15, 20, 25, 28, 32, 40, 48, 55, 60]
                        }
                    ],
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                function getChartColors(el) {
                    ...
                    if (!colors) return ["#727cf5"]; // default
                    ...
                    try {
                        ...
                        return parsed.map(c => {
                            ...
                            if (c.startsWith("--")) {
                                const val = getComputedStyle(document.documentElement).getPropertyValue(c).trim();
                                return val || c;
                            }
                            return c;
                        });
                    } catch (e) {
                        console.error("Invalid data-colors:", colors);
                        return ["#727cf5"];
                    }
                }

                // -------------------------------------------
                // CLEAN MINI CHART INIT
                // -------------------------------------------
                function initMiniChart(id, dataset) {
                ...
                // -------------------------------------------
                // MINI CHARTS (ADD MORE ANYTIME)
                // -------------------------------------------
                initMiniChart("#mini-chart-1", [10, 15, 14, 18, 20, 17, 22]);
                initMiniChart("#mini-chart-2", [5, 10, 7, 12, 15, 18, 13]);
                initMiniChart("#mini-chart-3", [8, 5, 9, 12, 10, 11, 15]);
                initMiniChart("#mini-chart-4", [20, 22, 25, 23, 27, 30, 32]);
                initMiniChart("#mini-chart-5", [12, 14, 16, 13, 19, 21, 20]);
                initMiniChart("#mini-chart-6", [3, 5, 4, 7, 6, 8, 9]);
                initMiniChart("#mini-chart-7", [25, 30, 28, 33, 35, 38, 40]);
                initMiniChart("#mini-chart-8", [7, 10, 9, 11, 13, 15, 18]);

                // -------------------------------------------
                // CLEAN SWIPER
                // -------------------------------------------
                if (document.querySelector(".marketplace-swiper")) {
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                // Initialize ALL swipers with class ".collection-slider"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                // Set the chart colors manually (clean & reliable)
                var chartColors = ["#405189", "#0ab39c", "#f7b84b", "#f06548"];
                ...
                var options = {
                    ...
                    series: [34, 27, 21, 13], // USA, Russia, Spain, Italy
                    ...
                    dataLabels: {
                        ...
                        formatter: function (value) {
                            return value.toFixed(1) + "%"; // percent inside pieces
                        },
                        style: {
                            fontSize: "12px",
                            fontWeight: "500",
                    ...
                    legend: {
                        show: false // You already have the country list below
                    },
                ...
                new ApexCharts(
                    document.querySelector("#creators-by-locations"),
                    options
                ).render();
            });
        </script>
