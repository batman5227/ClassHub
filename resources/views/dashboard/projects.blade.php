...
@section('content')
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body p-0 pb-2">
                                <div>
                                    <div id="projects-overview-chart" data-colors="[" --vz-primary",="" "--vz-warning",="" "--vz-success"]"="" data-colors-minimal="[" "--vz-primary-rgb,="" 0.1",="" 0.50"]"="" data-colors-interactive="[" "--vz-info",="" "--vz-warning"]"="" data-colors-creative="[" --vz-secondary",="" data-colors-corporate="[" "--vz-secondary",="" "--vz-danger"]"="" data-colors-galaxy="[" data-colors-classic="[" dir="ltr" class="apex-charts"></div>
                                </div>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                            ...
                            <table class="table table-nowrap table-centered align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/avatar-1.jpg') }}" class="avatar-xxs rounded-circle me-1 material-shadow" alt="">
                                            <a href="javascript: void(0);" class="text-reset">StarCode Kh</a>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                            ...
                                            <div class="avatar-group flex-nowrap">
                                                <div class="avatar-group-item">
                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                        <img src="{{ asset('assets/images/avatar-1.jpg') }}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                    </a>
                                                </div>
                                                <div class="avatar-group-item">
                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                        <img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                    </a>
                                                </div>
                                                <div class="avatar-group-item">
                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                        <img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/avatar-2.jpg') }}" class="avatar-xxs rounded-circle me-1 material-shadow" alt="">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <div class="avatar-group-item">
                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                        <img src="{{ asset('assets/images/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                    </a>
                                                </div>
                                                <div class="avatar-group-item">
                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                        <img src="{{ asset('assets/images/avatar-6.jpg') }}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/avatar-3.jpg') }}" class="avatar-xxs rounded-circle me-1 material-shadow" alt="">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <div class="avatar-group-item">
                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                        <img src="{{ asset('assets/images/avatar-7.jpg') }}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                    </a>
                                                </div>
                                                <div class="avatar-group-item">
                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                        <img src="{{ asset('assets/images/avatar-8.jpg') }}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/avatar-5.jpg') }}" class="avatar-xxs rounded-circle me-1 material-shadow" alt="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/avatar-6.jpg') }}" class="avatar-xxs rounded-circle me-1 material-shadow" alt="">
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                ...
                                                <div class="avatar-group-item">
                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                        <img src="{{ asset('assets/images/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-xxs material-shadow">
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
        ...
        <div class="row">
                        ...
                        <div class="table-responsive table-card">
                            <table class="table table-borderless table-nowrap align-middle mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="d-flex">
                                            <img src="{{ asset('assets/images/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                            <div>
                                                <h5 class="fs-13 mb-0">StarCode Kh</h5>
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                            <div>
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img src="{{ asset('assets/images/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                            <div>
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img src="{{ asset('assets/images/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                            <div>
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img src="{{ asset('assets/images/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-3 me-2 material-shadow">
                                            <div>
                                    ...
                                    <li class="chat-list left">
                                        <div class="conversation-list">
                                            <div class="chat-avatar">
                                                <img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="" class="material-shadow">
                                            </div>
                                                ...
                                                <div class="ctext-wrap">
                                                    <div class="message-img mb-0">
                                                        <div class="message-img-list">
                                                            <div>
                                                                <a class="popup-img d-inline-block" href="assets/{{ asset('assets/images/small/img-1.jpg') }}">
                                                                    <img src="{{ asset('assets/images/img-1.jpg') }}" alt="" class="rounded border">
                                                                </a>
                                                            </div>
                                                            <div class="message-img-link">
                                                                <ul class="list-inline mb-0">
                                                                    <li class="list-inline-item dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="assets/{{ asset('assets/images/small/img-1.jpg') }}" download=""><i class="ri-download-2-line me-2 text-muted align-bottom"></i>Download</a>
                                                                            <a class="dropdown-item" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Reply</a>
                                                                            <a class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward</a>
                                                                            <a class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>Bookmark</a>
                                                                            <a class="dropdown-item delete-item" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>Delete</a>
                                                        ...
                                                        <div class="message-img-list">
                                                            <div>
                                                                <a class="popup-img d-inline-block" href="assets/{{ asset('assets/images/small/img-2.jpg') }}">
                                                                    <img src="{{ asset('assets/images/img-2.jpg') }}" alt="" class="rounded border">
                                                                </a>
                                                            </div>
                                                            <div class="message-img-link">
                                                                <ul class="list-inline mb-0">
                                                                    <li class="list-inline-item dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="assets/{{ asset('assets/images/small/img-2.jpg') }}" download=""><i class="ri-download-2-line me-2 text-muted align-bottom"></i>Download</a>
                                                                            <a class="dropdown-item" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Reply</a>
                                                                            <a class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward</a>
                                                                            <a class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>Bookmark</a>
                                                                            <a class="dropdown-item delete-item" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>Delete</a>
            ...
            <div class="col-xxl-4 col-lg-6">
                <div class="card card-height-100">
                    ...
                    <div class="card-body">
                        <div id="prjects-status" data-colors="[" --vz-success",="" "--vz-primary",="" "--vz-warning",="" "--vz-danger"]"="" data-colors-minimal="[" --vz-primary",="" "--vz-primary-rgb,="" 0.85",="" 0.70",="" 0.50"]"="" data-colors-galaxy="[" class="apex-charts" dir="ltr"></div>
                        <div class="mt-3">
    ...
    @section('script')
        <!-- projects js -->
        <script src="{{ asset('assets/js/dashboard-projects.init.js') }}"></script>

        <script>
            document.addEventListener("DOMContentLoaded", function () {

                /* -----------------------------------
                GLOBAL: Get Color Array Function
                ------------------------------------*/
                function getChartColorsArray(id) {
                    ...
                    try {
                        ...
                        console.error("Invalid JSON in data-colors for #" + id, e);
                        return [];
                    }
                }

                /* -----------------------------------
                1️⃣ PROJECT OVERVIEW BAR CHART
                ------------------------------------*/
                function renderProjectOverviewChart() {
                    const chartId = "projects-overview-chart";
                    ...
                    const options = {
                        ...
                        series: [
                            { name: "Completed",    data: [44,55,41,67,22,43,21,49,72,88,65,80] },
                            { name: "In Progress",  data: [13,23,20,8,13,27,33,12,20,55,35,40] },
                            { name: "Pending",      data: [11,17,15,15,21,14,15,13,18,30,25,30] }
                        ],
                ...
                /* -----------------------------------
                2️⃣ RADIAL BAR CHARTS (AUTO MULTIPLE)
                ------------------------------------*/
                function renderRadialBars() {
                    document.querySelectorAll("[id^='radialBar_chart_']").forEach(function (el) {
                        const seriesValue = parseInt(el.getAttribute("data-chart-series")) || 50;
                ...
                /* -----------------------------------
                3️⃣ PROJECT STATUS DONUT CHART
                ------------------------------------*/
                function renderProjectsStatusChart() {
                    const chartId = "prjects-status";
                    const chartEl = document.getElementById(chartId);
                    if (!chartEl) return;
                    ...
                    const options = {
                        ...
                        colors: colors.length ? colors : ["#34c38f", "#556ee6", "#f1b44c", "#f46a6a"],
