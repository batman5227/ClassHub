...
@section('content')
                                    ...
                                    <div data-simplebar="" class="mx-n3 px-3" style="height: 375px;">
                                        <div class="vstack gap-3">
                                            <div class="d-flex gap-3">
                                                <img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="" class="avatar-sm rounded flex-shrink-0">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="{{ asset('assets/images/avatar-5.jpg') }}" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="{{ asset('assets/images/avatar-6.jpg') }}" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="{{ asset('assets/images/avatar-7.jpg') }}" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="{{ asset('assets/images/avatar-9.jpg') }}" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="{{ asset('assets/images/avatar-10.jpg') }}" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                        ...
                                        <table class="table table-hover table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>01</td>
                                                    <td>
                                                        <img src="{{ asset('assets/images/img-2.jpg') }}" alt="" class="me-2 rounded" height="40">
                                                ...
                                                <tr>
                                                    <td>02</td>
                                                    <td>
                                                        <img src="{{ asset('assets/images/img-3.jpg') }}" alt="" class="me-2 rounded" height="40">
                                                ...
                                                <tr>
                                                    <td>03</td>
                                                    <td>
                                                        <img src="{{ asset('assets/images/img-4.jpg') }}" alt="" class="me-2 rounded" height="40">
                                                ...
                                                <tr>
                                                    <td>04</td>
                                                    <td>
                                                        <img src="{{ asset('assets/images/img-5.jpg') }}" alt="" class="me-2 rounded" height="40">
                                                ...
                                                <tr>
                                                    <td>05</td>
                                                    <td>
                                                        <img src="{{ asset('assets/images/img-6.jpg') }}" alt="" class="me-2 rounded" height="40">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <img src="{{ asset('assets/images/avatar-1.jpg') }}" alt="" class="avatar-sm rounded-circle img-thumbnail">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <h5 class="mb-1 card-title">StarCode Kh</h5>
    ...
    @section('script')
        <!-- Dashboard init -->
        <script src="{{ asset('assets/js/dashboard-blog.init.js') }}"></script>
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                var options = {
                    ...
                    colors: ["#5563A9"],  // same as screenshot (muted blue/purple)
                    tooltip: {
                        y: {
                            formatter: function (val) {
                                return val + "%";
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                var options = {
                    series: [35, 45, 20], // Desktop, Mobile, Laptop
                    ...
                    colors: ["#4E5BA6", "#5EC6A8", "#F6C667"], // same as your screenshot
