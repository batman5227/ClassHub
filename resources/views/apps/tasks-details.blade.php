                        ...
                        <ul class="list-unstyled vstack gap-3 mb-0">
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('assets/images/avatar-10.jpg') }}" alt="" class="avatar-xs rounded-circle material-shadow">
                                    </div>
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('assets/images/avatar-8.jpg') }}" alt="" class="avatar-xs rounded-circle material-shadow">
                                    </div>
                                    <div class="flex-grow-1 ms-2">
                        ...
                        <div class="vstack gap-2">
                            ...
                            <div class="border rounded border-dashed p-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="fs-13 mb-1"><a href="javascript:void(0);" class="text-body text-truncate d-block">StarCode Kh admin.ppt</a></h5>
                                        <div>2.4MB</div>
                                    </div>
                                    <div class="flex-shrink-0 ms-2">
                                        <div class="d-flex gap-1">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="row g-2 mb-3">
                                                <div class="col-lg-1 col-sm-2 col-6">
                                                    <img src="{{ asset('assets/images/img-4.jpg') }}" alt="" class="img-fluid rounded">
                                                </div>
                                                <div class="col-lg-1 col-sm-2 col-6">
                                                    <img src="{{ asset('assets/images/img-5.jpg') }}" alt="" class="img-fluid rounded">
                                                </div>
                                            </div>
                                            <a href="javascript: void(0);" class="badge text-muted bg-light"><i class="mdi mdi-reply"></i> Reply</a>
                                            <div class="d-flex mt-4">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-3 flex-grow-1">
                                                            <h6 class="fs-15 mb-0"><a href="javascript:void(0);">StarCode Kh admin.ppt</a></h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>PPT File</td>
                        ...
                        <div class="mb-4 d-flex align-items-center">
                            ...
                            <div class="avatar-group justify-content-center">
                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Tonya Noble">
                                    <div class="avatar-xs">
                                        <img src="{{ asset('assets/images/avatar-10.jpg') }}" alt="" class="rounded-circle img-fluid">
                                    </div>
                                </a>
