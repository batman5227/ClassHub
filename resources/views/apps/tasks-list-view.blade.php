...
@section('content')
                            ...
                            <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                ...
                                <tbody class="list form-check-all">
                                    <tr>
                                        ...
                                        <td class="project_name"><a href="apps-projects-overview.html" class="fw-medium link-primary">StarCode Kh - v1.0.0</a></td>
                                        <td>
                                            <div class="d-flex">
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label d-flex align-items-center" for="mary-gant">
                                                        <span class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/avatar-4.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                        </span>
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label d-flex align-items-center" for="diego-norris">
                                                        <span class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/avatar-9.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                        </span>
    ...
    @section('script')
        ...
        <!-- titcket init js -->
        <script src="{{ asset('assets/js/tasks-list.init.js') }}"></script>
        <!-- Sweet Alerts js -->
