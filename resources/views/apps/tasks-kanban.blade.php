...
@section('content')
                    ...
                    <div class="col-auto ms-sm-auto">
                        <div class="avatar-group" id="newMembar">
                            <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Nancy">
                                <img src="{{ asset('assets/images/avatar-5.jpg') }}" alt="" class="rounded-circle avatar-xs">
                            </a>
                            ...
                            <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Tonya">
                                <img src="{{ asset('assets/images/avatar-10.jpg') }}" alt="" class="rounded-circle avatar-xs">
                            </a>
                            <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Thomas">
                                <img src="{{ asset('assets/images/avatar-8.jpg') }}" alt="" class="rounded-circle avatar-xs">
                            </a>
                            <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Herbert">
                                <img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="" class="rounded-circle avatar-xs">
                            </a>
                    ...
                    <div id="unassigned-task" class="tasks">
                        ...
                        <div class="card tasks-box">
                            <div class="card-body">
                                <div class="d-flex mb-2">
                                    <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate task-title"><a href="apps-tasks-details.html" class="d-block">Template - Admin Layout Design</a></h6>
                                    </div>
                                    <div class="flex-shrink-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="avatar-group">
                                            <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Tonya">
                                                <img src="{{ asset('assets/images/avatar-10.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                            <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Frank">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="avatar-group">
                                            <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Donald">
                                                <img src="{{ asset('assets/images/avatar-9.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                            <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Thomas">
                    ...
                    <div id="reviews-task" class="tasks">
                        <div class="card tasks-box">
                            <div class="card-body">
                                ...
                                <div class="tasks-img rounded" style="background-image: url('{{ asset('assets/images/img-7.jpg') }}');"></div>
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                    ...
                    <div id="new-task" class="tasks">
                        <div class="card tasks-box">
                            <div class="card-body">
                                ...
                                <div class="tasks-img rounded" style="background-image: url('{{ asset('assets/images/img-4.jpg') }}');"></div>
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <span class="badge bg-primary-subtle text-primary">UI/UX</span>
                                                ...
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label d-flex align-items-center" for="anna-adame">
                                                        <span class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/avatar-1.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                        </span>
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label d-flex align-items-center" for="frank-hook">
                                                        <span class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                        </span>
                                                        <span class="flex-grow-1 ms-2">
                                                            Frank Hook
                                                        </span>
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label d-flex align-items-center" for="alexis-clarke">
                                                        <span class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/avatar-6.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                        </span>
                                                        <span class="flex-grow-1 ms-2">
                                                            Alexis Clarke
                                                        </span>
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label d-flex align-items-center" for="herbert-stokes">
                                                        <span class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                        </span>
                                                        <span class="flex-grow-1 ms-2">
                                                            Herbert Stokes
                                                        </span>
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label d-flex align-items-center" for="michael-morris">
                                                        <span class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/avatar-7.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                        </span>
                                                        <span class="flex-grow-1 ms-2">
                                                            Michael Morris
                                                        </span>
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label d-flex align-items-center" for="nancy-martino">
                                                        <span class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/avatar-5.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                        </span>
                                                        <span class="flex-grow-1 ms-2">
                                                            Nancy Martino
                                                        </span>
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label d-flex align-items-center" for="thomas-taylor">
                                                        <span class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/avatar-8.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                        </span>
                                                        <span class="flex-grow-1 ms-2">
                                                            Thomas Taylor
                                                        </span>
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label d-flex align-items-center" for="tonya-noble">
                                                        <span class="flex-shrink-0">
                                                            <img src="{{ asset('assets/images/avatar-10.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                        </span>
                                                        <span class="flex-grow-1 ms-2">
                                                            Tonya Noble
                                                        </span>
    ...
    @section('script')
        ...
        <!-- dom autoscroll -->
        <script src="{{ asset('assets/js/dom-autoscroller.min.js') }}"></script>
        <!--taks-kanban-->
        <script src="{{ asset('assets/js/tasks-kanban.init.js') }}"></script>
    @endsection
@endsection
