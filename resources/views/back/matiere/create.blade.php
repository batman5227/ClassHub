            ...
            <div class="bg-gradient rounded-4 p-5 shadow-lg position-relative overflow-hidden"
                ...
                <div class="row align-items-center position-relative">
                    <div class="col-lg-8">
                        ...
                        <h1 class="display-4 fw-bold text-white mb-3">Nouvelle matière</h1>
                        <p class="text-white opacity-90 lead mb-4">Ajoutez une nouvelle matière à l'établissement</p>
                    </div>
