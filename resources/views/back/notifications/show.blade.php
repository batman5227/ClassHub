...
@section('title')
    Détails de la Notification - ClassHub
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Détails de la Notification</h4>
            ...
            <div class="card">
                <div class="card-header bg-gradient border-bottom">
                    <div class="d-flex align-items-center">
                        <div class="avatar me-3" style="width:50px;height:50px;font-size:18px">{{ substr($notification->titre, 0, 2) }}</div>
                        <div><h5 class="card-title mb-0 text-white">{{ $notification->titre }}</h5><span class="text-white-50">Notification</span></div>
                    </div>
                </div>
                <div class="card-body">
