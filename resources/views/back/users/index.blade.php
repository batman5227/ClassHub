        ...
        <div class="col-12">
            <div class="bg-gradient rounded-4 p-5 shadow-lg position-relative overflow-hidden"
                ...
                <div class="position-absolute bottom-0 start-0 opacity-10">
                    <i class="fas fa-user-shield fa-8x text-blue"></i>
                </div>
                    ...
                    <div class="col-lg-8">
                        <nav aria-label="breadcrumb" class="mb-3">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active text-blue" aria-current="page">Utilisateurs</li>
                            </ol>
                        </nav>
                        <h1 class="display-4 fw-bold text-blue mb-3">Gestion des utilisateurs</h1>
                        <p class="text-blue opacity-90 lead mb-4">Gérez les utilisateurs de l'application</p>
                        <div class="d-flex gap-3">
                            <div class="bg-white bg-opacity-20 rounded-3 px-4 py-2">
                                <small class="text-blue opacity-75 d-block">Total utilisateurs</small>
                                <span class="text-blue fw-bold">{{ count($users) }}</span>
                            </div>
                            <div class="bg-white bg-opacity-20 rounded-3 px-4 py-2">
                                <small class="text-blue opacity-75 d-block">Actifs</small>
                                <span class="text-blue fw-bold">{{ $users->where('status', 'actif')->count() }}</span>
                            </div>
                        </div>
                    </div>
