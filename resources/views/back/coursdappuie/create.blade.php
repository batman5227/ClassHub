...
@section('title')
    Ajouter un Cours d'Appui - ClassHub
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Ajouter un Cours d'Appui</h4>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('coursdappuie.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        <div class="mb-3">
