            ...
            <div class="bg-gradient-primary rounded-4 p-5 shadow-lg position-relative overflow-hidden">
                ...
                <div class="row align-items-center position-relative">
                    <div class="col-lg-8">
                        ...
                        <h1 class="display-4 fw-bold text-blue mb-3">Modification d'un groupe</h1>
                        <p class="text-blue opacity-90 lead mb-4">
                            Modifiez les informations de <span class="fw-bold bg-blue text-primary px-3 py-1 rounded-pill">{{ $groupe->nom }}</span>
                        </p>
                    </div>
