...
<div class="container-fluid px-4 py-5">
            ...
            <div class="bg-gradient-primary rounded-4 p-5 shadow-lg position-relative overflow-hidden">
                ...
                <div class="row align-items-center position-relative">
                    <div class="col-lg-8">
                        ...
                        <h1 class="display-4 fw-bold text-blue mb-3">Détails du groupe</h1>
                        <p class="text-blue opacity-90 lead mb-4">
                            Informations complètes sur <span class="fw-bold bg-blue text-primary px-3 py-1 rounded-pill">{{ $groupe->nom }}</span>
                        </p>
                    </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h3 class="fw-bold mb-0">{{ $groupe->nom }}</h3>
                            <p class="text-muted mb-0">Nom du groupe</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 hover-shadow-lg transition-all">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h3 class="fw-bold mb-0">{{ $groupe->created_at->format('d/m/Y') }}</h3>
            ...
            <div class="card border-0 shadow-sm rounded-4 hover-shadow-lg transition-all">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h3 class="fw-bold mb-0">{{ $groupe->classe->nom ?? 'Non assignée' }}</h3>
                            <p class="text-muted mb-0">Classe associée</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <div class="bg-light rounded-4 p-4">
                                ...
                                <div class="mb-3">
                                    <label class="text-muted small text-uppercase">ID du groupe</label>
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="bg-primary bg-opacity-10 rounded-2 p-2 me-3">
                                            <i class="fas fa-fingerprint text-primary"></i>
                                        </div>
                                        <code class="fw-semibold">{{ $groupe->id }}</code>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="bg-light rounded-4 p-4">
                                ...
                                <div class="mb-3">
                                    <label class="text-muted small text-uppercase">Classe associée</label>
                                    <div class="d-flex align-items-start mt-2">
                                        <div class="bg-info bg-opacity-10 rounded-2 p-2 me-3">
                                            <i class="fas fa-chalkboard text-info"></i>
                                        </div>
                                        <div>
                                            <span class="fw-semibold">{{ $groupe->classe->nom ?? 'Non assignée' }}</span>
                                            @if($groupe->classe)
                                                <small class="text-muted d-block">
                                                    ID: {{ substr($groupe->classe->id, 0, 6) }}...
                                                </small>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <span class="fw-semibold">{{ $groupe->created_at->format('d/m/Y H:i') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <span class="fw-semibold">{{ $groupe->updated_at->format('d/m/Y H:i') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="d-flex justify-content-center gap-3 mt-5">
        <a href="{{ route('groupes.edit', $groupe->id) }}" class="btn btn-warning btn-lg px-5 rounded-pill shadow-sm hover-lift">
...
<style>
    ...
    code { background: none; color: #667eea; font-size: 0.9rem; }
</style>
@endpush
