    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Ajouter un Groupe</h4>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header bg-gradient border-bottom">
                    <h5 class="card-title text-white">Informations du Groupe</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('groupes.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        <div class="mb-3">
