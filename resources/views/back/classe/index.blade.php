...
<div class="container-fluid px-4 py-5">
            ...
            <div class="bg-gradient-primary rounded-4 p-5 shadow-lg position-relative overflow-hidden">
                ...
                <div class="row align-items-center position-relative">
                    <div class="col-lg-8">
                        <nav aria-label="breadcrumb" class="mb-3">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active text-blue" aria-current="page">Classes</li>
                            </ol>
                        </nav>
                    ...
                    <div class="col-lg-4 text-lg-end mt-4 mt-lg-0">
                        <a href="{{ route('classes.create') }}" class="btn btn-light btn-lg rounded-pill px-5 shadow-sm hover-lift">
                            <i class="fas fa-plus-circle me-2 text-primary"></i>Nouvelle classe
                        </a>
                    </div>
                </div>
            </div>
    ...
    <!-- Grille des classes -->
    <div class="row g-4" id="classes-grid">
        @forelse ($classes as $classe)
            <div class="col-xl-4 col-lg-6 classe-item" data-name="{{ strtolower($classe->nom) }}">
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden h-100 hover-lift">
                    ...
                    <div class="card-body p-4">
                        <h4 class="fw-bold mb-3">{{ $classe->nom }}</h4>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center text-muted">
                                ...
                                <span>Groupes: {{ $classe->groupes->count() }}</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <small class="text-muted">
                                ID: {{ substr($classe->id, 0, 6) }}...{{ substr($classe->id, -4) }}
                            </small>
                        </div>
                    </div>
