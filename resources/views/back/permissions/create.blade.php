            ...
            <div class="bg-gradient-primary rounded-4 p-5 shadow-lg position-relative overflow-hidden">
                ...
                <div class="row align-items-center position-relative">
                    <div class="col-lg-8">
                        ...
                        <h1 class="display-4 fw-bold text-blue mb-3">Création d'une permission</h1>
                        <p class="text-blue opacity-90 lead mb-4">
                            Ajoutez une nouvelle permission à l'application
                        </p>
                    </div>
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                <div class="card-header bg-white border-0 p-4">
                    ...
                    <p class="text-muted mb-0 mt-1">
                        Remplissez les informations ci-dessous pour créer une nouvelle permission
                    </p>
                </div>
                    ...
                    <form action="{{ route('permissions.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description"
                                      ...
                                      rows="4"
                                      placeholder="Décrivez l'utilité de cette permission...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">
