            ...
            <div class="bg-gradient-primary rounded-4 p-5 shadow-lg position-relative overflow-hidden">
                ...
                <div class="row align-items-center position-relative">
                    <div class="col-lg-8">
                        ...
                        <h1 class="display-4 fw-bold text-blue mb-3">Modification d'un rôle</h1>
                        <p class="text-blue opacity-90 lead mb-4">
                            Modifiez les informations du rôle <span class="fw-bold bg-white text-primary px-3 py-1 rounded-pill">{{ $role->nom }}</span>
                        </p>

                        <div class="d-flex gap-3">
                            <div class="bg-white bg-opacity-20 rounded-3 px-4 py-2">
                                <small class="text-white opacity-75 d-block">ID du rôle</small>
                                <span class="text-white fw-bold font-mono">{{ substr($role->id, 0, 8) }}...</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                <div class="card-header bg-white border-0 p-4">
                    ...
                    <p class="text-muted mb-0 mt-1">
                        Modifiez les informations ci-dessous pour mettre à jour le rôle
                    </p>
                </div>
                    ...
                    <form action="{{ route('roles.update', $role->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="nom" class="form-label fw-semibold">
                                <i class="fas fa-tag text-primary me-2"></i>Nom du rôle
                            </label>
                            <input type="text"
                                   name="nom"
                                   id="nom"
                        ...
                        <div class="mb-4">
                            ...
                            @enderror
                            <small class="text-muted">
                                Une description claire aidera à comprendre le rôle
                            </small>
                        </div>

                        <div class="d-flex justify-content-between align-items-center mt-4 pt-4 border-top">
                            <a href="{{ route('roles.index') }}" class="btn btn-outline-secondary btn-lg px-5 rounded-pill">
