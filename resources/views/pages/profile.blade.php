                                            ...
                                            <div>
                                                <div class="d-flex align-items-center py-3">
                                                    <div class="avatar-xs flex-shrink-0 me-3">
                                                        <img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="" class="img-fluid rounded-circle material-shadow">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div>
                                                ...
                                                <div class="d-flex align-items-center py-3">
                                                    <div class="avatar-xs flex-shrink-0 me-3">
                                                        <img src="{{ asset('assets/images/avatar-4.jpg') }}" alt="" class="img-fluid rounded-circle material-shadow">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div>
                                                ...
                                                <div class="d-flex align-items-center py-3">
                                                    <div class="avatar-xs flex-shrink-0 me-3">
                                                        <img src="{{ asset('assets/images/avatar-5.jpg') }}" alt="" class="img-fluid rounded-circle material-shadow">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex mb-4">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/img-4.jpg') }}" alt="" height="50" class="rounded material-shadow">
                                                </div>
                                            ...
                                            <div class="d-flex mb-4">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/img-5.jpg') }}" alt="" height="50" class="rounded material-shadow">
                                                </div>
                                                <div class="flex-grow-1 ms-3 overflow-hidden">
                                                    <a href="javascript:void(0);">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/img-6.jpg') }}" alt="" height="50" class="rounded material-shadow">
                                                </div>
                                                <div class="flex-grow-1 ms-3 overflow-hidden">
                                                    <a href="javascript:void(0);">
